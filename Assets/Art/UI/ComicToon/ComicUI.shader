Shader "UI/ComicToon"
{
 ...
 SubShader {
  ...
  Pass {
   ...
   float _Hue, _TargetHue, _Saturation, _Brightness;
   ...
   fixed4 frag(v2f i):SV_Target {
    ...
    float3 h=rgb2hsv(c.rgb); h.x=(_TargetHue>=0 && h.y>.3)?_TargetHue:frac(h.x+_Hue); h.y*=_Saturation; h.z=saturate(h.z*_Brightness); c.rgb=hsv2rgb(h); c*=i.color;
