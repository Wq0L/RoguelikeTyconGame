...
const bases={
 ...
 P1:[2,0],P2:[5,0],P3:[7,2],P4:[10,3],P5:[9,-2],P6:[12,0],P7:[7,-5],P8:[12,-5],P9:[13,4],P10:[7,5],
 E1:[0,-2],E2:[-5,-7],E3:[0,-7],E4:[5,-12],E5:[0,-12],
 E6:[-10,-12],E7:[-5,-12],E8:[0,-17],E9:[-5,-17],E10:[-10,-17],E11:[0,-22],E12:[-9,-9],Z11:[-15,-10]
};
...
console.log(`PASS: ${data.nodes.length} explicit XY positions; no overlapping nodes or connectors through unrelated nodes.`);
